...
import { getDefaultCompactConfig } from "../agents/core/compact"
...
export function createPreemptiveCompactionHook(
  ...
  const compactConfig = getDefaultCompactConfig()
  ...
  const toolExecuteAfter = async (
    ...
    const { autoThresholdBuffer, reservedForSummary } = compactConfig
    const effectiveWindow = actualLimit - reservedForSummary
    const threshold = effectiveWindow - autoThresholdBuffer

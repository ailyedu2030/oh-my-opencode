...
export const tddWorkflowSkill: BuiltinSkill = {
  name: "tdd-workflow",
  description: "Test-Driven Development workflow with red-green-refactor cycle, test-first development, testing patterns, etc.",
  template: `# TDD Workflow Skill

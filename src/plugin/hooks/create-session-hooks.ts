...
import {
  ...
  createLearningPersistenceHook,
  createContinuousLearningHook,
} from "../../hooks"
...
export type SessionHooks = {
  ...
  learningPersistence: ReturnType<typeof createLearningPersistenceHook> | null
  continuousLearning: ReturnType<typeof createContinuousLearningHook> | null
}
...
export function createSessionHooks(args: {
  ...
  const learningPersistence = isHookEnabled("learning-persistence")
    ? safeHook("learning-persistence", () => createLearningPersistenceHook(ctx))
    : null

  const continuousLearning = isHookEnabled("continuous-learning")
    ? safeHook("continuous-learning", () => createContinuousLearningHook(ctx))
    : null
